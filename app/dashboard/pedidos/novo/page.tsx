...
const existingContacts = [
  { id: 1, name: "Empresa Festa Feliz", phone: "(11) 99999-1234", address: "Rua das Flores, 123 - São Paulo, SP" },
  { id: 2, name: "João Silva", phone: "(11) 98888-5678", address: "Av. Paulista, 1000 - São Paulo, SP" },
  { id: 3, name: "Maria Santos", phone: "(11) 97777-9012", address: "Rua Augusta, 500 - São Paulo, SP" },
  { id: 4, name: "Buffet Sabor & Arte", phone: "(11) 96666-3456", address: "Rua dos Eventos, 789 - São Paulo, SP" },
]

// Períodos de entrega
const deliveryPeriods = [
  { id: "comercial", name: "Horário Comercial", description: "8h às 12h e 13h às 17h" },
  { id: "manha", name: "Manhã", description: "8h às 12h" },
  { id: "tarde", name: "Tarde", description: "13h às 18h" },
  { id: "noite", name: "Noite", description: "18h às 21h" },
  { id: "fixo", name: "Horário Fixo", description: "Definir horário específico" },
]
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold text-[#0F032D]">Novo Pedido</h1>
          <p className="text-[#0F032D]/60">Crie um novo pedido de locação</p>
        </div>
      </div>
          ...
          <div className="space-y-6 lg:col-span-2">
            ...
            <Card className="border-none shadow-md">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  <Label htmlFor="clientAddress">Endereço de Entrega *</Label>
            ...
            <Card className="border-none shadow-md">
              <CardHeader>
                ...
                <CardDescription>Adicione os produtos para locação</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                {/* Adicionar Produto */}
                <div className="space-y-2">
                    ...
                    <SelectContent>
                      {availableProducts.map(product => (
                        <SelectItem key={product.id} value={product.id.toString()}>
                          {product.name} - R$ {product.price.toFixed(2)} ({product.stock} disponíveis)
                        </SelectItem>
                      ))}
                    </SelectContent>
                  </Select>
            ...
            <Card className="border-none shadow-md">
              <CardHeader>
                ...
                <CardDescription>Defina quando será a entrega e retirada</CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                {/* Entrega */}
                <div className="space-y-4">
                  <h4 className="font-medium text-[#0F032D]">Entrega</h4>
                  <div className="grid gap-4 md:grid-cols-3">
                    ...
                    {deliveryPeriod === "fixo" && (
                      <div className="space-y-2">
                        <Label htmlFor="deliveryTime">Horário Fixo</Label>
                        <Input
                          id="deliveryTime"
                          type="time"
                          value={deliveryTime}
                ...
                {/* Retirada */}
                <div className="space-y-4">
                  <h4 className="font-medium text-[#0F032D]">Retirada</h4>
                  <div className="grid gap-4 md:grid-cols-3">
                    <div className="space-y-2">
                    ...
                    {pickupPeriod === "fixo" && (
                      <div className="space-y-2">
                        <Label htmlFor="pickupTime">Horário Fixo</Label>
                        <Input
                          id="pickupTime"
                          type="time"
                          value={pickupTime}
